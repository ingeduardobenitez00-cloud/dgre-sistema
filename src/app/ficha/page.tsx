...
export default function FichaPage() {
  ...
  // New queries for general report
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
             ...
             <Separator className="my-6" />
                <div className="space-y-2">
                    <h3 className="text-base font-semibold text-foreground">Informes Globales</h3>
                    <p className="text-sm text-muted-foreground">
                        Genera un documento PDF consolidado con todos los informes e imágenes del sistema.
                    </p>
                    <Button 
                        onClick={handleGenerateGeneralReport} 
                        disabled={isLoadingDatos || isLoadingAllReports || isLoadingAllImages || isGeneratingGeneralReport} 
                        className="mt-2"
                    >
                        {isGeneratingGeneralReport ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Download className="mr-2 h-4 w-4" />}
